...
/**
 * This is an event sourced entity. It has a state, {@link HelloWorldState}, which
 ...
 */
public class HelloWorldEntity extends PersistentEntity<HelloWorldCommand, HelloWorldEvent, HelloWorldState> {
    /**
     * An entity can define different behaviours for different states, but it will
     * always start with an initial behaviour. This entity only has one behaviour.
     */
    @Override
    public Behavior initialBehavior(Optional<HelloWorldState> snapshotState) {
        /*
        ...
        BehaviorBuilder b = newBehaviorBuilder(
                snapshotState.orElse(new HelloWorldState("Hello", LocalDateTime.now().toString()))
        );
        ...
        b.setEventHandler(GreetingMessageChanged.class,
                ...
                // the event.
                evt -> new HelloWorldState(evt.message, LocalDateTime.now().toString())
        );
